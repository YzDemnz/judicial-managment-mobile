...
export const currentMobileVersion = Application.nativeApplicationVersion ?? '3.2.2';
export const currentMobileBuild = Number.parseInt(Application.nativeBuildVersion ?? '6', 10) || 0;
